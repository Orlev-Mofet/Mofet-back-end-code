                    ...
                    <tr class="border-b dark:border-neutral-500">
                        ...
                        <td class="whitespace-nowrap px-6 py-4">
                            <a rel="tooltip" title="Show Answers" class="inline-block items-center px-3 py-1.5 bg-indigo-400 hover:bg-indigo-500 text-white text-sm font-medium rounded-md mb_-9"
                                href="{{ route('users.answersByQuestion', "question_id=".$question->id."&user_id=".request()->query("id")) }}" >
                        ...
                        <td class="whitespace-nowrap px-6 py-4 w-3/4 text-wrap">{{ $question->question }}</td>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-center flex flex-col justify-center items-center ">
                            ...
                            Abused by: Abused by: {{ $question->abuse_user?->surname ?? 'Unknown' }} ({{ $question->abuse_user?->school_name ?? 'Unknown' }} {{ $question->abuse_user?->city ?? 'Unknown' }})
                        ...
                        <td class="whitespace-nowrap px-6 py-4">
                            Answers: {{ $question->answers ? count($question->answers) : 0 }}
                        </td>
                    </tr>
                    <?php $i ++; ?>
                    @endforeach
