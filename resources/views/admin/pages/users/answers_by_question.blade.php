...
<div>
    <div class="sm:col-span-6 flex flex-col col-span-full bg-white shadow-lg border border-gray-200">
        <header class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <a
                type="button"
                href="{{ route('users.questions', "id=".request()->query("user_id")) }}"
            ...
            <table class="min-w-full text-left text-sm font-light mt-4">
                <thead class="border-b font-medium dark:border-neutral-500">
                    <tr>
                        ...
                        <th scope="col" class="px-6">Answered User</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b dark:border-neutral-500">
                        ...
                        <td class="whitespace-nowrap px-6 py-4">{{ $answer->user->surname }} ({{ $answer->user->school_name }} {{ $answer->user->city }})</td>
                        <td class="whitespace-nowrap px-6 py-4 w-3/4 text-wrap">{{ $answer->answer }}</td>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-center flex flex-col justify-center items-center ">
                            ...
                            Abused by: {{ $answer->abuse_user->surname }} ({{ $answer->abuse_user->school_name }} {{ $answer->abuse_user->city }})
